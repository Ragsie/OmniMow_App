...
* [How to install on Android (Wiki Docs)]((https://github.com/Ragsie/ros_mower_app/wiki/Installation-on-andorid)](https://github.com/Ragsie/ros_mower_app/wiki/Android-Installation)) 
* [How to install on iPhone / iOS via Sideloadly (Wiki Docs)]((https://github.com/Ragsie/ros_mower_app/wiki/Installation-on-ios)](https://github.com/Ragsie/ros_mower_app/wiki/iOS-Installation-Sideloadly))
